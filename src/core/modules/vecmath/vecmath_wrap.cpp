...
{
    return m_Vector == pOther->get_vector();
}
...
CVector* CVector::operator+(object value)
{
    ...
    {
        CVector* pOther = extract<CVector*>(value);
        return new CVector(m_Vector + pOther->get_vector());
    }
...
{
    return m_Vector.WithinAABox(pMins->get_vector(), pMaxs->get_vector());
}

float CVector::get_distance(CVector* pOther)
{
    return m_Vector.DistTo(pOther->get_vector());
}

float CVector::get_distance_sqr(CVector* pOther)
{
    return m_Vector.DistToSqr(pOther->get_vector());
}

void CVector::mul_add(CVector* pA, CVector* pB, float fScalar)
{
    m_Vector.MulAdd(pA->get_vector(), pB->get_vector(), fScalar);
}

float CVector::dot(CVector* pOther)
{
    return m_Vector.Dot(pOther->get_vector());
}
...
{
    return new CVector(m_Vector.Cross(pOther->get_vector()));
}

CVector* CVector::get_min(CVector* pOther)
{
    return new CVector(m_Vector.Min(pOther->get_vector()));
}

CVector* CVector::get_max(CVector* pOther)
{
    return new CVector(m_Vector.Max(pOther->get_vector()));
}