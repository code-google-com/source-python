...
public:
	...
	void add_listener(PyObject* pCallable);
	void remove_listener(PyObject* pCallable);
	bool is_registered(PyObject* pCallable);

	int count();
	PyObject* get_value_from_index(int iIndex);
