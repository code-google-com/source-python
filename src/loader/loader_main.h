...
// Definitions
//---------------------------------------------------------------------------------
#define PYLIB_NAME_WIN32_RELEASE	"_engines/plat-win/python33.dll"
#define PYLIB_NAME_WIN32_DEBUG		"_engines/plat-win/python33_d.dll"
#define PYLIB_NAME_LINUX_RELEASE	"_engines/plat-linux/libpython3.3m.so.1.0"
#define PYLIB_NAME_LINUX_DEBUG		"_engines/plat-linux/libpython3.3dm.so.1.0"

#define CORE_NAME_WIN32				"_core/core.dll"
#define CORE_NAME_LINUX				"_core/core.so"
...
#	define MSVCRT_LIB "_engines/plat-win/msvcr100d.dll"
#	define MSVCP_LIB  "_engines/plat-win/msvcp100d.dll"
#elif defined(_WIN32) && !defined(DEBUG)
#	define PYLIB_NAME PYLIB_NAME_WIN32_RELEASE
#	define MSVCRT_LIB "_engines/plat-win/msvcr100.dll"
#	define MSVCP_LIB  "_engines/plat-win/msvcp100.dll"
